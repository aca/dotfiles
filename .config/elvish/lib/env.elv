...
if (eq $E:_ELVISH_ENV "") {
    ...
    set E:FZF_DEFAULT_OPTS = '--reverse --color "gutter:-1" --inline-info --cycle -m --bind ctrl-a:toggle-all --bind ctrl-j:down --bind ctrl-k:up --bind ctrl-w:toggle-preview'
