...
glide.keymaps.set("normal", "<C-1>", "tab 0");
glide.keymaps.set("normal", "<C-2>", "tab 1");
glide.keymaps.set("normal", "<C-3>", "tab 2");
glide.keymaps.set("normal", "<C-4>", "tab 3");
glide.keymaps.set("normal", "<C-5>", "tab 4");
glide.keymaps.set("normal", "<C-6>", "tab 5");
glide.keymaps.set("normal", "<C-7>", "tab 6");
glide.keymaps.set("normal", "<C-8>", "tab 7");
