-- Based on monotone.nvim, generated by ExtractHighlights
...
nvim_set_hl(0, "VertSplit", { foreground = 12762812 })
nvim_set_hl(0, "Folded", { background = 2630948, foreground = 9603463, italic = true })
nvim_set_hl(0, "FoldColumn", {})
nvim_set_hl(0, "SignColumn", {})
nvim_set_hl(0, "Substitute", {})
nvim_set_hl(0, "LineNr", { foreground = 12762812 })
nvim_set_hl(0, "CursorLineNr", { foreground = 12762812 })
...
vim.defer_fn(function()
    ...
    nvim_set_hl(0, "Error", { bold = true, foreground = 16145237 })
    nvim_set_hl(0, "ErrorMsg", { background = 16145237, bold = true, foreground = 0 })
    nvim_set_hl(0, "Warning", { bold = true, foreground = 14985831 })
    nvim_set_hl(0, "WarningMsg", { bold = true, foreground = 14985831 })
