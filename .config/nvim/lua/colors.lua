...
-- -- nvim_set_hl(0, 'StatusLine',  {   foreground = 10262165,   underline = true } )
-- -- nvim_set_hl(0, 'StatusLineNC',  {   foreground = 6183257,   underline = true } )
...
--     nvim_set_hl(0, "DiagnosticVirtualTextError", { italic = true, fg="#2a2a2a"})
--     nvim_set_hl(0, "DiagnosticVirtualTextWarn",  { italic = true, fg="#2a2a2a"})
--     nvim_set_hl(0, "DiagnosticVirtualTextInfo",  { italic = true, fg="#2a2a2a"})
--     nvim_set_hl(0, "DiagnosticVirtualTextHint",  { italic = true, fg="#2a2a2a"})
